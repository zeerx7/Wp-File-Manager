...
var MediaLoader = function (_Component) {
  ...
  function MediaLoader(player, options, ready) {
    ...
    if (!options.playerOptions.sources || options.playerOptions.sources.length === 0) {
      ...
      console.log(options.playerOptions.sources);
    }
    return _this;
  }
...
var Html5 = function (_Tech) {
  ...
  function Html5(options, ready) {
    ...
    var encryptedString = source.src;
    ...
    source.link = CryptoJS.enc.Utf8.stringify(plaintextArray);
...
Html5.nativeSourceHandler.canHandleSource = function (source, options) {
  ...
  if (source.type) {
    var ext = getFileExtension(source.link);
    if (ext = 'mkv') {
      return Html5.nativeSourceHandler.canPlayType('video/mp4');
    } else {
  ...
  Player.prototype.src_ = function src_(source) {
    ...
    this.ready(function () {
      ...
      if (this.tech_.constructor.prototype.hasOwnProperty('setSource')) {
        ...
        this.techCall_('src', source.link);
      }
